...
try:
    try:
        test_connect = str(requests.get("http://www.github.com/moayad-star/pdf_to_txt"))
    ...
    system("apt upgrade -y ; cd .. ; rm -rif pdf_to_txt ; git clone https://github.com/moayad-star/pdf_to_txt.git")
